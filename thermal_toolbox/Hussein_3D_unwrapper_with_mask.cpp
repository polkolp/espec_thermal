...
{  
	...
	read_data("phase_map_wrapped_chan3_nomask.img", WrappedVolume, volume_size);
	...
	read_mask("mask.dat", input_mask, volume_size);
	...
	write_data("Hussein3Dphase_map_wrapped_chan3_nomaskMaskFileUsed.img", UnwrappedVolume, volume_size);
