...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
path(path,'mydirectory\thermal_tools') % define path of the tool set

storepath = 'E:\Documents\Research\Ellis\MGRIN\Data\'; %define path to store phase maps
nameOfTest = 'Zerodur_try3'; %define name of test
%% Initial Setup
...
when = clock;
datadir = strcat(storepath,num2str(when(1)),'_',num2str(when(2)),'_',num2str(when(3)),'_',nameOfTest)
mkdir(datadir)
cd(datadir)
mkdir('phasemaps')
